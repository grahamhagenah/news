...
- `/weekend/` lists Friday to Sunday: the weekend it is, or from Monday to Thursday the one coming (`weekend_days`), and `/weekend/next/` the weekend after; each links to the other (`PUBLIC_WEEKENDS`). Their filter shows a kind in place. Every public page's footer links to this weekend's.
