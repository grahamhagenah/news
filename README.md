...
- The newsfeed's menu beside it ("All sources") shows one source's posts, of every kind, kept in the address (`?source=`). The events pages' ("All venues") shows one venue's events of every kind, kept in the address (`?venue=`); a film playing at several theaters narrows to the chosen one's times. On Boston, Daily's music, film and talks pages, a choice goes to the home page, which has every kind; on the weekend and tonight pages it lists only the venues with events then.
