...
- GitHub Actions rebuilds and deploys to GitHub Pages on every push and every 30 minutes, and makes an empty commit if the repo goes 50 days without one, so GitHub doesn't switch the schedule off.
