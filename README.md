...
- A listing's view has a Share button: the device's share sheet where there is one, with "Aldous Harding · The Sinclair · Mon, Sep 14, 8pm" and the listing's own link; elsewhere the same, copied. Shares are counted in GoatCounter as `share/<venue>`.
