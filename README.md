...
- `/weekend/` lists Friday to Sunday: the weekend it is, or from Monday to Thursday the one coming (`weekend_days`). Its filter shows a kind in place. Every public page's footer links to it.
